        ...
        <form class="form-horizontal" name="contact_form" id="contact_form" enctype="multipart/form-data" method="post" action="process_form.php">
          ...
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-5">
                <input type="email" value="<?php echo $results[0]["email_address"] ?>" placeholder="Email ID" id="email_id" class="form-control" name="email_id"><span id="email_id_err" class="error"></span>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-5">
                <input type="number" value="<?php echo $results[0]["contact_no1"] ?>" placeholder="Contact Number" id="contact_no1" class="form-control" name="contact_no1"><span id="contact_no1_err" class="error"></span>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-5">
                <input type="number" value="<?php echo $results[0]["contact_no2"] ?>" placeholder="Contact Number" id="contact_no2" class="form-control" name="contact_no2"><span id="contact_no2_err" class="error"></span>
                <span class="help-block">Maximum of 11 digits only and only numbers.</span>
              </div>
            </div>
